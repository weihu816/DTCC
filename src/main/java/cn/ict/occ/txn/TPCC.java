...
public class TPCC {
	...
	public static int numTxnsAborted = 0;
...
//			LOG.warn("Fail to commit transaction " + transaction.transactionId);
	...
	public static void PaymentById(int w_id, int d_id, String c_id) throws TransactionException {
		...
		key_customer = TPCCGenerator.buildString(c_w_id, "_", c_d_id, "_", c_id);
...
//		transaction.read(table, key, names)

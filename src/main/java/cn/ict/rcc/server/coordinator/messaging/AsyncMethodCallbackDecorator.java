...
public class AsyncMethodCallbackDecorator implements AsyncMethodCallback {
	...
	public AsyncMethodCallbackDecorator(AsyncMethodCallback callback,
			TNonblockingSocket transport, Member member,
	...
	public AsyncMethodCallbackDecorator(TNonblockingSocket transport,

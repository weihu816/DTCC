...
public class StartResponseBulk implements org.apache.thrift.TBase<StartResponseBulk, StartResponseBulk._Fields>, java.io.Serializable, Cloneable, Comparable<StartResponseBulk> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("StartResponseBulk");
  ...
  static {
    schemes.put(StandardScheme.class, new StartResponseBulkStandardSchemeFactory());
    schemes.put(TupleScheme.class, new StartResponseBulkTupleSchemeFactory());
  }

  public List<List<String>> output; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(StartResponseBulk.class, metaDataMap);
  }

  public StartResponseBulk() {
  }
   ...
   */
  public StartResponseBulk(StartResponseBulk other) {
    if (other.isSetOutput()) {
      List<List<String>> __this__output = new ArrayList<List<String>>(other.output.size());
      for (List<String> other_element : other.output) {
        List<String> __this__output_copy = new ArrayList<String>(other_element);
  ...
  public StartResponseBulk deepCopy() {
    return new StartResponseBulk(this);
  }
  ...
  public java.util.Iterator<List<String>> getOutputIterator() {
    return (this.output == null) ? null : this.output.iterator();
  }

  public void addToOutput(List<String> elem) {
    if (this.output == null) {
  ...
  public StartResponseBulk setOutput(List<List<String>> output) {
    this.output = output;
    return this;
  }
  ...
  public StartResponseBulk setDep(Graph dep) {
    this.dep = dep;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case OUTPUT:
      if (value == null) {
        ...
        setOutput((List<List<String>>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof StartResponseBulk)
      return this.equals((StartResponseBulk)that);
    return false;
  }

  public boolean equals(StartResponseBulk that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(StartResponseBulk other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("StartResponseBulk(");
    boolean first = true;
  ...
  private static class StartResponseBulkStandardSchemeFactory implements SchemeFactory {
    public StartResponseBulkStandardScheme getScheme() {
      return new StartResponseBulkStandardScheme();
    }
  }

  private static class StartResponseBulkStandardScheme extends StandardScheme<StartResponseBulk> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, StartResponseBulk struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.output = new ArrayList<List<String>>(_list60.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StartResponseBulk struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.output != null) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.LIST, struct.output.size()));
          for (List<String> _iter66 : struct.output)
          {
            {
  ...
  private static class StartResponseBulkTupleSchemeFactory implements SchemeFactory {
    public StartResponseBulkTupleScheme getScheme() {
      return new StartResponseBulkTupleScheme();
    }
  }

  private static class StartResponseBulkTupleScheme extends TupleScheme<StartResponseBulk> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, StartResponseBulk struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        oprot.writeI32(struct.output.size());
        for (List<String> _iter68 : struct.output)
        {
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, StartResponseBulk struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.output = new ArrayList<List<String>>(_list70.size);
